...
const albumInfoCard = () => {
  ...
  return (
    <>
      <div className=''>
        <div className='bg-gradient-to-b from-slate-50 via-violet-600 to-indigo-600 sm:h-1/2 h-[30rem] flex space-x-10'>
          <div className='m-3 text-3xl'>
            <FaArrowCircleLeft onClick={handleLocation} />
          </div>
          <div>
            <img src={data[7]} alt="" className='sm:w-[20rem] sm:ml-20 sm:py-10 mx-auto max-sm:absolute w-[20rem]' />
          </div>

          <div className='mt-[10rem] space-x-2 space-y-1'>
            <div></div>
            <div className='flex'>
          ...
          <div className='sm:mt-[17rem] max-sm:absolute mt-[28rem] space-x-2 flex'>
