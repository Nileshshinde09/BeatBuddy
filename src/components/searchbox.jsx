...
<div className={`bg-white ${result?'':'hidden'} sm:max-h-[15rem] max-h-[5rem] h-[20rem] object-top text-black text-center rounded-xl no-scrollbar p-2 space-y-2 overflow-y-scroll`}>
    {
      result?
